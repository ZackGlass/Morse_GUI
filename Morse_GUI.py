...
# Credit for morse code dictionary code: https://www.cl.cam.ac.uk/projects/raspberrypi/tutorials/robot/morse_code/
MORSE = {
        'A': '.-', 
        'B': '-...', 
        'C': '-.-.', 
...
def toMorse():
    ...
    try:
        ...
        #print("Error: No Corresponding Morse Code value for character")
